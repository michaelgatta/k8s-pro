pipeline {
    ...
    stages {
        ...
        stage("k8s Deployment"){
            steps {
                script {
                    withKubeConfig(caCertificate: '', clusterName: '', contextName: '', credentialsId: 'jenkins-kubernetes-credential', namespace: '', restrictKubeConfigAccess: false, serverUrl: 'https://api-raycoy-new-kops-k8s-l-qhsifq-5ca502e379f90d15.elb.us-east-1.amazonaws.com') {
